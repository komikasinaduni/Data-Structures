...
INSERT INTO Loans(loan_id,member_id,book_id,loan_date,due_date,return_date)VALUES
        ...
        (304,101,203,'2026-02-11','2026-02-25','2026-02-1');
SELECT * FROM Authors;
SELECT * FROM Members;
/*SELECT * FROM Books;
SELECT * FROM Loans;
